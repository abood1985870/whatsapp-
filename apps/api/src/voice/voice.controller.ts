...
export class VoiceController {
   ...
   */
  @Get("entitlements")
  async myEntitlements(@CurrentOrganization() organizationId: string, @CurrentUser() user: any) {
  ...
  async listAgents(@CurrentOrganization() organizationId: string) {
  ...
  @UseGuards(VoiceGuard, PermissionGuard)
  @RequirePermission("voice.agent.manage")
  async updateAgent(@CurrentOrganization() organizationId: string, @Param("id") id: string, @Body() dto: any, @CurrentUser() user: any) {
  ...
  @UseGuards(VoiceGuard, PermissionGuard)
  @RequirePermission("voice.read")
  async agentVersions(@CurrentOrganization() organizationId: string, @Param("id") id: string) {
  ...
  @UseGuards(VoiceGuard, PermissionGuard)
  @RequirePermission("voice.read")
  async listNumbers(@CurrentOrganization() organizationId: string) {
  ...
  async availableNumbers(@CurrentOrganization() organizationId: string, @Query("countryCode") countryCode = "SA") {
  ...
  @UseGuards(VoiceGuard, PermissionGuard)
  @RequirePermission("voice.numbers.manage")
  async removeNumber(@CurrentOrganization() organizationId: string, @Param("id") id: string, @CurrentUser() user: any) {
  ...
  @UseGuards(VoiceGuard, PermissionGuard)
  @RequirePermission("voice.calls.read")
  async callDetail(@CurrentOrganization() organizationId: string, @Param("id") id: string) {
  ...
  async recordingAccess(@CurrentOrganization() organizationId: string, @Param("id") id: string, @CurrentUser() user: any) {
  ...
  async analytics(@CurrentOrganization() organizationId: string) {
  ...
  @UseGuards(VoiceGuard, PermissionGuard)
  @RequirePermission("voice.calls.read")
  async customerTimeline(@CurrentOrganization() organizationId: string, @Param("contactId") contactId: string) {
  ...
  @UseGuards(VoiceGuard, PermissionGuard)
  @RequirePermission("voice.read")
  async diagnosticsOverview(@CurrentOrganization() organizationId: string) {
